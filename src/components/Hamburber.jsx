...
const handLinkClose = () => {
  ...
  return (
    ...
    <div className={Change ? 'mt-3 z-10 fixed left-0 w-[50%] h-screen bg-[#ecf0f3] p-10 ease-in sm:hidden duration-500 rounded-sm' : 'fixed w-[65%] h-screen bg-[#ecf0f3] p-10 rounded-sm ease-in duration-500 left-[-100%]'}>
